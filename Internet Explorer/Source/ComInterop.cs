...
public enum DBIMF : int
{
    ...
    {
        [PreserveSig]
        long GetClassID(out Guid pClassID);

        [PreserveSig]
        long IsDirty();

        [PreserveSig]
        long Load([In, MarshalAs(UnmanagedType.Interface)] IStream pStm);

        [PreserveSig]
        long Save([In, MarshalAs(UnmanagedType.Interface)] IStream pStm, [In] bool fClearDirty);

        [PreserveSig]
        long GetSizeMax([Out] out UInt64 pcbSize);
    }
	...
	public struct MSG
	{
        public HandleRef hwnd;// IntPtr hwnd;
		public UInt32 message;
        public IntPtr wParam;//UInt32 wParam;
        public IntPtr lParam;//Int32 lParam;
		public UInt32 time;
		public POINT pt;
	}
