...
function eucasesShowHint(caller, ev, celex, toPar, uiLangId, langId) {
    ...
    xmlhttp.onreadystatechange = function () {
        if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
            ...
            hintEl.innerHTML = '<a href="' + caller.href + '" target="_blank">' + caller.href + '</a>'; //EUCASES_TEXTS[EUCASES_UI_LANG]['msgErrorHintLoading'];
        }
    }
...
function eucasesRemoveAllLinks() {
    ...
    //if (confirm(EUCASES_TEXTS[EUCASES_UI_LANG]['confirmRemoveLinks'])) {
    //if (document.getElementsByClassName('eucases-term').length > 0 || document.getElementsByClassName('eucases-link').length > 0) {
    location.reload();
    //}
    //else {
    //    alert(EUCASES_TEXTS[EUCASES_UI_LANG]['cMsgNoLinksSetByELCFound']);
    //}
    //}
}
...
function eucasesRemoveCurrentLink() {
    ...
    //if (confirm(EUCASES_TEXTS[EUCASES_UI_LANG]['cPlzConfirmRmLnkSel'])) {
    ...
    //}
    //else {
    //    alert(EUCASES_TEXTS[EUCASES_UI_LANG]['cPlsSelLink']);
    //}
...
function eucasesShowProcessingMessage() {
    ...
    eucasesLoadingElement.innerHTML = EUCASES_TEXTS[EUCASES_UI_LANG]['processingLinksMessage'];
...
function eucasesSetLinks() {
    ...
    xmlhttp.onreadystatechange = function () {
        if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
            ...
            alert(EUCASES_TEXTS[EUCASES_UI_LANG]['cSuccess']);
        }
    }
    ...
    //if (confirm(EUCASES_TEXTS[EUCASES_UI_LANG]['confirmCheckForLinks'])) {
